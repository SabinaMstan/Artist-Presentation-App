...
const AboutPage = (props) => {
  ...
  return(
    <SafeAreaView style={styles.container}>
      <Text style = {styles.mainTitle}>About me
      </Text>
      <ScrollView>
        ...
        <GenerateSectionList data = {ExhibitData} mainTitle = 'Exhibitions'/>
        <GenerateSectionList data = {ProjectData} mainTitle = 'Collaborative projects'/>
      </ScrollView>
    </SafeAreaView>
  );
}
